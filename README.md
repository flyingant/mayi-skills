...
- `mayi-project-estimate`: use when you need a structured workday estimate from text/docx/pptx requirements.
- `mayi-travel`: use when you want deep cultural travel research for a city (museums, ancient architecture, archaeology).

## Skill Testing

Use the eval kit in `skills/_evals/` to dry-run skills before production:

- `skills/_evals/test-cases.md` — test case definitions per skill
- `skills/_evals/rubric.md` — scoring criteria for output quality
- `skills/_evals/regression-checklist.md` — checklist to run after any skill change
